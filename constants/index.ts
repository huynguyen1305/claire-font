export const LIEN_HE_LIST = [
  ...
  },
  {
    ...
    location_description:
      "Chỉ cách Sân bay quốc tế Tân Sơn Nhất 5 phút, nằm trên trục đường Phổ Quang đối diện bệnh viện Quốc tế Tâm Anh, bạn sẽ tìm thấy Claire Tân Bình ấm áp, riêng tư chào đón bạn tại khu villa cao cấp biệt lập Him Lam.",
    img: "/tanbinh.png",
    mapImg:
      "https://maps.google.com/maps?q=him%20lam%203e%20t%C3%A2n%20b%C3%ACnh&t=m&z=15&output=embed&iwloc=near",
    address: "Số 14 Khu Biệt Thự Him Lam 3E, Phổ Quang, P.2, Quận Tân Bình",
